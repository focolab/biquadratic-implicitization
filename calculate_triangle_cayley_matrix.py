...
# calculate and save polynomial used to compute cayley matrix. this is slow, so
# leave commented out and read from storage after first execution
...
with open('biquadratic_triangle_cayley_matrix_mathematica.txt', 'w') as f:
